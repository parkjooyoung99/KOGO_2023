...
melanoma.enhanced = enhanceFeatures(melanoma.enhanced, melanoma, 
                                    model="xgboost",feature_names=hvgs, nrounds=0)
...
CellChat::netVisual_bubble(cellchat, sources.use =  c(3), targets.use =c(4), remove.isolate = FALSE, angle.x = 45,thresh = 0.05)
